...
const Footer = () => {
  ...
  return (
    <footer
      id="footer"
      className=" bg-slate-50 h-64 w-full z-50 dark:bg-gray-900 "
    >
        ...
        <div className="mx-auto container px-4 xl:px-12 2xl:px-4">
          <div className="flex flex-col items-center lg:items-start sm:justify-between sm:flex-row">
            ...
            <div className="sm:w-full lg:w-1/2 px-6">
              <h4 className="font-bold mb-0 sm:mb-4 text-lg">Compañia</h4>
              <ul className="flex justify-center flex-col sm:items-start items-center sm:justify-start">
                <li className="mt-2">
                  <Link
                    to="/servicios"
            ...
            <div className="sm:w-full lg:w-1/2 px-6 mb-0 sm:mb-4 mt-5 sm:mt-0">
              <h4 className="font-bold text-lg">Poductos</h4>
            ...
            <div className="sm:w-full lg:w-1/2 flex flex-col justify-center items-center sm:items-center ">
              <h4 className="font-bold mb-4 mt-5 sm:mt-0 text-lg">Seguinos</h4>
              <div className="flex ">
                ...
                <Link
                  to="https://www.instagram.com/autocentrocdelu/?igshid=MzRlODBiNWFlZA%3D%3D"
                  target="_blank"
                >

...
export const Navbar = () => {
  ...
  return (
    <nav className="">
      <div className="bg-red-100 font-sans top-0 left-0">
        <div className="bg-white shadow w-full py-1">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between py-4 h-16">
              <div className="w-24 h-24 object-cover cursor-pointer flex items-center">
              ...
              <div className={`block sm:hidden bg-white border-t-2 py-2 ${isMenuOpen ? "block" : "hidden"}`}>

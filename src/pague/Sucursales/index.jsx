...
import fondo02 from "../../utiles/IMG/sucursales/sucursal3.jpg";
            ...
            <div className="flex items-center justify-around gap-2">
              <div>
                <iframe
                  width="100%"
                  height="250"
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d26300.273693941203!2d-58.54627580000001!3d-34.5146911!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bcb0a31e03db41%3A0xaf1fd10506421428!2sVilla%20Adelina%2C%20Provincia%20de%20Buenos%20Aires!5e0!3m2!1ses-419!2sar!4v1699820944039!5m2!1ses-419!2sar"
                  allowFullScreen=""
                  loading="lazy"
              ...
              <div className="flex flex-col gap-3 justify-center items-start">
                ...
                <p className="text-lg sm:text-xl subpixel-antialiased lining-nums ">
                  <strong>Localidad:</strong> Villa Adelina
                </p>
                <p className="text-lg sm:text-xl subpixel-antialiased lining-nums ">
        ...
        <div className="bg-white bg-opacity-60 rounded-lg p-4 shadow flex flex-col">
          ...
          <div className="w-full h-80 flex items-center justify-center">
            <img
              src={fondo02}
              alt="Sucursal 1"
              className="w-auto  h-full object-cover rounded-md mb-4"
            />
          </div>
        </div>
      </div>
